...
class PhpRedis_Purger extends Purger {
	...
	public function purge_all() {
		...
		if ( is_network_admin() ) {
			...
			_$host = isset( $_SERVER['HTTP_X_FORWARDED_HOST'\] ) ? $_SERVER['HTTP_X_FORWARDED_HOST'] : $parse['host'];_
			_$total_keys_purged = $this->delete_keys_by_wildcard( $prefix . $parse['scheme'] . 'GET' . $host . $parse['path'] . '_' );
